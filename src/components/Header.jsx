        ...
        <div className="flex gap-4 items-center">
           {children} 
            ...
            <div className="flex items-center gap-3">
                <button className="flex gap-3 items-center py-2.75 px-4.5 rounded-md bg-white cursor-pointer">
                    <span className="text-[#98A2B3]">This week</span>
                    <img src="/Vector (23).svg" alt="" />
                </button>
                <button className="flex gap-3 items-center py-2.75 px-4.5 rounded-md bg-[#49B0C9] cursor-pointer">
